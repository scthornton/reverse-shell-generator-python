...
def main():
    parser = argparse.ArgumentParser(description='Generate reverse shell commands for security testing.')
    ...
    parser.add_argument('--url-encode', '-u', action='store_true', help='URL encode the output')
    parser.add_argument('--base64', '-b', action='store_true', help='Base64 encode the output')
